...
namespace Puzzle4UbyNAM.Services
{
    public class ProductService : IProductService
    {
        ...
        public ProductService(IRepository<Product, int> productRep, IRepository<ProductType, int> productTypeRep, 
            IRepository<ProductBrand, int> productBrandRep, IMapper mapper, IHostingEnvironment hostingEnvironment)
        {
        ...
        {
            return productBrandRep.GetAll().Select(e => new IdNameDto(e.Id, e.Name)).ToList();
        }
